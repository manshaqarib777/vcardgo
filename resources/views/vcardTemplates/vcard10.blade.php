            ...
            <div class="vcard-one__timing py-3 px-1">
                ...
                <div class="container pb-4">
                    <div class="row g-3">
                        ...
                        @endif
                        @if($vcard->category_a_text && $vcard->category_a_text_checkbox)
                        <div class="col-sm-6 col-12">
                            <div class="card business-card flex-row justify-content-center">
                            <span class="me-2">
                        ...
                        @endif
                        @if($vcard->category_b_text && $vcard->category_b_text_checkbox)
                        <div class="col-sm-6 col-12">
                            <div class="card business-card flex-row justify-content-center">
                            <span class="me-2">
                        ...
                        @endif
                        @if($vcard->category_c_text && $vcard->category_c_text_checkbox)
                        <div class="col-sm-6 col-12">
                            <div class="card business-card flex-row justify-content-center">
                            <span class="me-2">
                        ...
                        @endif
                        @if($vcard->category_d_text && $vcard->category_d_text_checkbox)
                        <div class="col-sm-6 col-12">
                            <div class="card business-card flex-row justify-content-center">
                            <span class="me-2">
                        ...
                        @endif
                        @if($vcard->category_e_text && $vcard->category_e_text_checkbox)
                        <div class="col-sm-6 col-12">
                            <div class="card business-card flex-row justify-content-center">
                            <span class="me-2">
