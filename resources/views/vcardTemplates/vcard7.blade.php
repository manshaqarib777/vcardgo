        ...
        <div class="main-bg py-5 collapse terms-policies-section">
            @if(!empty($vcard->privacy_policy) && checkFeature('privacy_policy'))
                <div class="container contactus-section">
                    ...
                    <div class="main-contact px-sm-3 px-4 py-md-5 py-4 m-3">
                        <div class="px-3 ">
            ...
            @endif
            <div class="text-center mt-3">
                <button class="btn px-4 vcard-seven-btn text-dark cursor-pointer terms-policies-btn">{{ __('messages.common.back') }}</button>
            </div>
        </div>
    </div>
