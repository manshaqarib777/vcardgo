            ...
            <div class="row align-items-center flex-column-reverse flex-lg-row">
                <div class="col-lg-6">
                    <div class="hero-content mt-5 mt-lg-0">
                        ...
                        <p class="text-secondary fs-5 mb-5">{{ __('messages.create_your_business_digital_card_with_lots_of_information') }}
                        </p>
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="d-flex justify-content-center my-3">
                            <h4 class="text-center mb-6 mt-2 pricing">
                                <span class="fs-1">{{ $plan->currency->currency_icon }}{{ $plan->price }}</span>
                                @if($plan->frequency == 1)
                        ...
                        <ul class="pricing-plan-features text-secondary text-start mx-auto fs-6">
                            ...
                            <li class="{{ $value == 1 ? 'active-check' : 'unactive-check' }}"><span class="check-box"><i
