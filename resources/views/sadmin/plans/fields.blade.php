<div class="row">
    ...
    <div class="col-lg-6 mb-7">
        ...
        {!! Form::number('price', isset($plan) ? $plan->price : null, ['class' => 'form-control', 'min'=>'0', 'step' => '0.01', 'placeholder' => __('messages.form.price'), 'required', isset($plan) && $plan->is_trial ? 'disabled' : '']) !!}
    </div>
    <div class="col-lg-6 mb-7">
